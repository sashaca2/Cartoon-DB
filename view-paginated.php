                        ...
                        // number of results to show per page
                                        ...
                                        if ($result = $mysqli->query("SELECT * FROM cartoons ORDER BY toon_no"))
                                        {
                                                if ($result->num_rows != 0)
                                                {
                                                        ...
                                                        // display pagination
                                                        echo "<p><a href='viewcartoons.php'>View All</a> | <b>View Page:</b> ";
                                                        ...
                                                        echo '<td>' . $row[2] . '</td>';
                                                        echo '<td>' . $row[3] . '</td>';
                                                        echo '<td><a href="editcartoons.php?toon_no=' . $row[0] . '">Edit Toon</a></td>';
                                                        echo '<td><a href="editmeta.php?toon_no=' . $row[0] . '">Add New Meta</a></td>';
                                                        echo "</tr>";
                                                        }
